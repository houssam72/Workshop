...
class Accordion2 extends Component {
  ...
  render = () => (
    <div className="accordion st-content-tab" style={{ marginTop:this.props.i==1 ?'80px' : '0px',background:"#33373e" ,width:'600px',marginLeft:'25%',marginTop:'15%'}} >
      ...
      {this.state.isShow ? (
        <div className="blc-contents-accordion " style={{background:"#33373e",paddingBottom:'0px'}} >{this.props.children}</div>
      ) : (
        ""
      )}
    </div>
